...
async def test_update_document_success(client, current_user):
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        "routes.documents.collections.get_document_by_id"
    ) as mock_get_document_by_id, patch("routes.documents.collections.update_document") as mock_update_document:
...
async def test_update_document_error_integrity_breach(client, current_user):
    ...
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        "routes.documents.collections.get_document_by_id"
    ) as mock_get_document_by_id, patch(
        "routes.documents.collections.update_document", side_effect=IntegrityBreach
...
async def test_update_document_error_internal_server_error(client, current_user):
    ...
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        ...
        "routes.documents.collections.update_document", side_effect=Exception
    ) as mock_update_document:
...
async def test_delete_document_success(client, current_user):
    ...
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        "routes.documents.collections.get_document_by_id"
    ) as mock_get_document_by_id, patch("routes.documents.collections.delete_document") as mock_delete_document, patch(
        "routes.documents.get_current_user", return_value=current_user
    ):
...
async def test_delete_document_error_internal_server_error(client, current_user):
    ...
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        ...
        "routes.documents.collections.delete_document", side_effect=Exception("Unexpected error")
...
async def test_search_documents_success(client, current_user):
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        "routes.documents.collections.search_documents"
...
async def test_search_documents_error_internal_server_error(client, current_user):
    ...
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        "routes.documents.collections.search_documents"
    ) as mock_search_documents, patch("routes.documents.get_current_user", return_value=current_user):
...
async def test_get_document_history_success(client, current_user):
    with patch("routes.documents.collections.get_collection_by_id") as mock_get_collection_by_id, patch(
        ...
        "routes.documents.collections.get_document_history"
    ) as mock_get_document_history:
